...
for numero in range(1, n_sequencia -1):
    soma = fibonacin[-1] + fibonacin[-2]
    fibonacin.append(soma)

strr = ''
espaco = ' '
for numero in fibonacin:
    if numero != fibonacin[-1]:
        strr += str(numero) + espaco
    else:
        strr += str(numero)
